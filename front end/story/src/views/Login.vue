    ...
    <section class="blog">
      <div class="container">
        <div class="mydiv">
          ...
          <!-- 用户名、密码输入 -->
          <div class="input">
            <div class="user_id">用户名:</div>
            <el-input type="text" v-model="userAccount" class="input_style"></el-input>
            <br />
            <div class="user_pass">密码:</div>
            <el-input type="password" v-model="password" class="input_style"></el-input>
            <br />
          </div>
